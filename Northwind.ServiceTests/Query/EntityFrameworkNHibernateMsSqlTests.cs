...
{
    [TestFixture]
    public class EntityFrameworkNHibernateMsSqlTests : QueryTestBase<NorthwindContext, 
        Categories, Customers, CustomerDemographics, Employees, Orders, OrderDetails, Products, Regions, Shippers, Suppliers, Territories>
    {
        ...
        {
            return new NorthwindContext(new Uri("http://localhost.:50555/NHibernateMsSql.svc/"));
        }
