...
using Northwind.ServiceTests.EntityFrameworkModelFirstAllOracleService;

namespace Northwind.ServiceTests.Query
{
    [TestFixture]
    public class EntityFrameworkModelFirstAllOracleTests : QueryTestBase<NorthwindContext,
        Categories, Customers, CustomerDemographics, Employees, Orders, OrderDetails, Products, Regions, Shippers, Suppliers, Territories>
    {
        ...
        {
            return new NorthwindContext(new Uri("http://localhost.:50555/EntityFrameworkModelFirstAllOracle.svc/"));
        }
