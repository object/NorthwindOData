...
using Northwind.ServiceTests.EntityFrameworkModelFirstOracleService;
...
namespace Northwind.ServiceTests.Query
{
        ...
        Categories, Customers, CustomerDemographics, Employees, Orders, OrderDetails, Products, Regions, Shippers, Suppliers, Territories>
    {
        ...
        {
            return new NorthwindOracleContext(new Uri("http://localhost.:50555/EntityFrameworkModelFirstOracle.svc/"));
        }
