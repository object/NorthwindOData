...
//using Northwind.ServiceTests.EntityFrameworkCodeFirstOracleService;

namespace Northwind.ServiceTests.Query
{
    //[TestFixture]
    //public class EntityFrameworkCodeFirstOracleTests : QueryTestBase<NorthwindContext,
    ...
    //    {
    //        return new NorthwindContext(new Uri("http://localhost.:50555/EntityFrameworkCodeFirstOracle.svc/"));
    //    }
