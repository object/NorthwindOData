...
using Northwind.ServiceTests.EntityFrameworkModelFirstAllMsSqlService;

namespace Northwind.ServiceTests.Query
{
    [TestFixture]
    public class EntityFrameworkModelFirstAllMsSqlTests : QueryTestBase<NorthwindContext,
        Categories, Customers, CustomerDemographics, Employees, Orders, OrderDetails, Products, Regions, Shippers, Suppliers, Territories>
    {
        ...
        {
            return new NorthwindContext(new Uri("http://localhost.:50555/EntityFrameworkModelFirstAllMsSql.svc/"));
        }
