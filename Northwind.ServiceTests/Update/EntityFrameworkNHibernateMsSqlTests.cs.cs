...
using Northwind.ServiceTests.EntityFrameworkNHibernateMsSqlService;

namespace Northwind.ServiceTests.Update
{
    [TestFixture]
    public class EntityFrameworkNHibernateMsSqlTests : UpdateTestBase<NorthwindContext,
        Categories, Customers, CustomerDemographics, Employees, Orders, OrderDetails, Products, Regions, Shippers, Suppliers, Territories>
    {
        public EntityFrameworkNHibernateMsSqlTests()
            : base(new Northwind.ServiceTests.Query.EntityFrameworkNHibernateMsSqlTests())
        {
        }
